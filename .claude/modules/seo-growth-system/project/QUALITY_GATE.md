...
Este ficheiro define o standard mínimo para aprovar, aprovar com notas, bloquear, pedir dados ou pedir autorização antes de entregar, publicar, implementar ou avançar com trabalho SEO relevante.
...
O comando [`/seo`](../commands/seo.md) orquestra o fluxo por modos.  
