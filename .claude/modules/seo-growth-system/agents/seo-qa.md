...
Validar se uma recomendação, entrega, alteração, implementação ou go-live SEO pode avançar com segurança e qualidade.
...
O `seo-qa` valida.  
A skill `seo-quality-gate` define o procedimento operacional.  
...
5. `seo-qa` aplica o gate antes da entrega final, publicação, implementação ou go-live.
...
3. [`../project/QUALITY_GATE.md`](../project/QUALITY_GATE.md) — standard oficial do gate.
4. [`../skills/seo-quality-gate/SKILL.md`](../skills/seo-quality-gate/SKILL.md) — procedimento operacional do gate.
